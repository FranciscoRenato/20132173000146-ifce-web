<?php 
  ...
  if(!$result)
	...
	//echo "<script> alert('Dados excluídos com sucesso.'); location.href='..' </script>";
	//echo "<script> alert('Dados excluídos com sucesso.'); location.href='../Tela_principal.php';</script>";
